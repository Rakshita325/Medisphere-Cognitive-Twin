...
def main():
    ...
    save_path = str(model_file_path("cvd"))
    global_model.save(save_path)
    print(f"Global Federated CVD model saved to: {save_path}")

    history_path = round_history_file_path("cvd")
    save_json(history_path, round_history)
    print(f"CVD training history saved to: {history_path}")
    ...
    metadata_path = metadata_file_path("cvd")
    save_json(metadata_path, metadata)
    print(f"CVD model metadata saved to: {metadata_path}")
